...
// async function printSearchResult(title) {
//   if (title === "PublicChat") {
//     printPublicChatSearchResultsHelper(SearchResultData);
//   } else if (title === "PrivateChat") {

//   // } else if (title === "ESN") {
//   //   const resultName = await getSearchResultForESNByName($("#keywords").val());
//   //   const resultStatus = await getSearchResultForESNByStatus($("#keywords").val());
//   //   if (resultName.length === 0) {
//   //     printESNSearchByStatusResultsHelper(resultStatus);
//   //   } else 
...
// const checkAnnouncement = function(){

//   const readAnnouncement = sessionStorage.getItem('readAnnouncement');
//   if(readAnnouncement == "read")
//     $('#announcement-btn').attr('style', 'color:white');
//   else if(readAnnouncement == "unread")
//     $('#announcement-btn').attr('style', 'color:red');
//   else
//     $('#announcement-btn').attr('style', 'color:yellow');

//   if($('title').text() === "Announcement")
//   {
//     $('#announcement-btn').attr('style', 'color:white');
//     sessionStorage.setItem('readAnnouncement', 'read');
//   }
// }
